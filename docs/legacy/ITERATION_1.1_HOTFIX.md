...
**Изменённые файлы:**
- `k8s/overlays/prod/embedding-service.yaml` - imagePullPolicy: IfNotPresent
...
- ✅ Заменено на `k8s/base/` + `k8s/overlays/prod/`
...
10. `k8s/overlays/prod/embedding-service.yaml` - imagePullPolicy: IfNotPresent
