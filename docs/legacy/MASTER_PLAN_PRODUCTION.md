...
- `k8s/overlays/prod/embedding-service.yaml` (imagePullPolicy, сборка образа)
- `k8s/overlays/prod/postgres-pgvector.yaml` (imagePullPolicy)
...
- `k8s/overlays/prod/llm-server.yaml` (условный деплой)
...
**Файлы:**
- `k8s/base/postgres/statefulset.yaml`
- `k8s/overlays/prod/postgres-pgvector.yaml` (удалить)
