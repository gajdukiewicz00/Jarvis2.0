...
export SECURITY_ALLOWED_ACTIONS="${SECURITY_ALLOWED_ACTIONS:-MEDIA_CONTROL,VOLUME_UP,VOLUME_DOWN,SET_VOLUME,VOLUME_SET,MUTE,UNMUTE,PLAY_PAUSE,PAUSE,NEXT,PREV,OPEN_APP,OPEN_URL,HOTKEY,NOTIFY,SCREENSHOT,LOCK_SCREEN,SYSTEM_COMMAND,SCENARIO}"
