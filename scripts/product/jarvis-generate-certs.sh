...
SERVER_DNS_NAMES=(
    ...
    "embedding-service"
    "llm-service"
    "api-gateway.jarvis-prod.svc.cluster.local"
    "security-service.jarvis-prod.svc.cluster.local"
    "user-profile.jarvis-prod.svc.cluster.local"
    "nlp-service.jarvis-prod.svc.cluster.local"
    "orchestrator.jarvis-prod.svc.cluster.local"
    "voice-gateway.jarvis-prod.svc.cluster.local"
    "smart-home-service.jarvis-prod.svc.cluster.local"
    "life-tracker.jarvis-prod.svc.cluster.local"
    "analytics-service.jarvis-prod.svc.cluster.local"
    "planner-service.jarvis-prod.svc.cluster.local"
    "memory-service.jarvis-prod.svc.cluster.local"
    "pc-control.jarvis-prod.svc.cluster.local"
    "embedding-service.jarvis-prod.svc.cluster.local"
    "llm-service.jarvis-prod.svc.cluster.local"
    "*.jarvis-prod.svc.cluster.local"
)
...
echo "  2) Apply/update the Kubernetes TLS secret: ${PROJECT_ROOT}/scripts/product/jarvis-apply-edge-tls-secret.sh"
echo "  3) Update /etc/hosts for edge HTTPS/WSS: sudo ${PROJECT_ROOT}/scripts/product/jarvis-setup-hosts.sh"
echo "  4) Local runtime HTTPS/WSS can use:"
