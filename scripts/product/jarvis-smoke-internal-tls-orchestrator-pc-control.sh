...
usage() {
  cat <<'EOF'
Usage: ./scripts/product/jarvis-smoke-internal-tls-orchestrator-pc-control.sh [--namespace=jarvis-prod]
...
echo "✅ orchestrator routed the migrated call to https://pc-control.jarvis-prod.svc.cluster.local:8084"
