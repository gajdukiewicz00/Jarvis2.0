...
usage() {
  cat <<'EOF'
Usage: ./scripts/product/jarvis-smoke-internal-tls-voice-gateway-smart-home-service.sh [--namespace=jarvis-prod]
...
echo "✅ voice-gateway routed the migrated call to https://smart-home-service.jarvis-prod.svc.cluster.local:8086"
